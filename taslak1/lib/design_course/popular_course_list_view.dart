            ...
            return GridView(
              ...
              children: List<Widget>.generate(
                ...
                (int index) {
                  ...
                  return CategoryView(
                    callback: () {
                      widget.callBack(snapshot.data.categories[index].postId);
                    },
                                            ...
                                            child: Row(
                                              ...
                                              children: <Widget>[
                                                CircleAvatar(
                                                  radius: 25.0,
                                                  backgroundImage:
                                                      NetworkImage(category.userImage),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: AspectRatio(
                                aspectRatio: 1.28,
                                child: Image.network(category.postImage)),
                          ),
                        ),
                      ),
                    ),
